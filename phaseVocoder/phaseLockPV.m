...
fileName='03-FreakFandango-GypsySong';
    ...
    hopout=hopin*1.3;                                % hop length for output
    ...
    [y,sr] = wavread([dir fileName '.wav'],[1000000 2000000]);
    siz=size(y); %wavread(infile,'size');                % length of song in samples
    ...
    wavwrite(tt,sr,16,'D:\matlab\FAST\sounds\timestrechtedPhaseLockedV.wav');
    fclose('all');